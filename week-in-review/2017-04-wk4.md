...
### This Week's Goal: HealthPlanG

### Things I MUST Do This Week:
- [x] Follow Up with Ashley & Troy about HPG Store
- [ ] Follow up on upcoming trip tasks
- [x] Follow up with Dan about MaxCentive
- [x] Start MaxCentive persona work
- [x] Complete HPG Store design
